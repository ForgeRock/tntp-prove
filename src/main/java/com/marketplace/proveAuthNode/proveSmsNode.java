...
@Node.Metadata(outcomeProvider  = AbstractDecisionNode.OutcomeProvider.class,
               configClass      = proveSmsNode.Config.class)
public class proveSmsNode extends AbstractDecisionNode {

    private final Pattern DN_PATTERN = Pattern.compile("^[a-zA-Z0-9]=([^,]+),");
    private final Logger logger = LoggerFactory.getLogger(proveSmsNode.class);
     ...
     */
    @Inject
    public proveSmsNode(@Assisted Config config, @Assisted Realm realm, ShutdownManager shutdownManager) throws HttpApplicationException {
        this.config = config;
        this.realm = realm;
    ...
    public Action process(TreeContext context) {
        try {
          ...
          JsonValue data = new JsonValue(new LinkedHashMap<String, String>(1));
          JsonValue namedData = new JsonValue(new LinkedHashMap<String, String>(1));
          namedData.put("messageText", "Prove: Your OTP is #####.");
          data.put("phoneNumber", nodeState.get("telephoneNumber"));
          data.put("namedData", namedData);
          parameters.put("app", "SmsOTPVerification");
          parameters.put("clientContext", correlationId);
    ...
    public static final class OutcomeProvider implements org.forgerock.openam.auth.node.api.OutcomeProvider {
        ...
        private static final String BUNDLE = proveSmsNode.class.getName();
